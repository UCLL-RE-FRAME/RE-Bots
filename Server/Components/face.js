...
face_template.innerHTML = /*html*/ `
  ...
  <div class="eyes_container">
    <svg id="eyes_svg" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="450 2550 1300 885" height="375px"><!--  was  1500  -->
  ...
  class extends HTMLElement {
    ...
    connectedCallback() {
      ...
      this.socket.addEventListener("open", (event) => {
        ...
        this.socket.send(
          JSON.stringify({ payload: "Hello Server, I'm James's face ..." })
        );
      });
    ...
    mover(target, x, y) {
      this._shadowRoot
        ...
        .setAttribute("transform", `translate(${(x - 150) / 2},${y - y})`);
    }
